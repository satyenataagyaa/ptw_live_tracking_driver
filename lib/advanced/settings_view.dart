...
class _SettingsViewState extends State<SettingsView> {
  ...
  Widget _buildSelectField(Map<dynamic, dynamic> setting) {
    ...
    values.forEach((dynamic item) {
      ...
      menuItems.add(DropdownMenuItem(value: itemValue, child: Text(itemLabel)));
    });
  ...
  Widget _buildGeofenceTestPanel() {
    ...
    radiusItems
        .add(const DropdownMenuItem(value: '100', child: Text('100 meters')));
    radiusItems
        .add(const DropdownMenuItem(value: '150', child: Text('150 meters')));
    radiusItems
        .add(const DropdownMenuItem(value: '200', child: Text('200 meters')));
    radiusItems
        .add(const DropdownMenuItem(value: '500', child: Text('500 meters')));
    radiusItems
        .add(const DropdownMenuItem(value: '1000', child: Text('1000 meters')));
    radiusItems
        .add(const DropdownMenuItem(value: '5000', child: Text('5000 meters')));
    radiusItems.add(
        const DropdownMenuItem(value: '10000', child: Text('10000 meters')));

    List<DropdownMenuItem<String>> loiteringDelayItems = [];
    loiteringDelayItems
        .add(const DropdownMenuItem(value: '1000', child: Text('1000 ms')));
    loiteringDelayItems
        .add(const DropdownMenuItem(value: '5000', child: Text('5000 ms')));
    loiteringDelayItems
        .add(const DropdownMenuItem(value: '10000', child: Text('10000 ms')));
    loiteringDelayItems
        .add(const DropdownMenuItem(value: '30000', child: Text('30000 ms')));
    loiteringDelayItems
        .add(const DropdownMenuItem(value: '60000', child: Text('60000 ms')));
